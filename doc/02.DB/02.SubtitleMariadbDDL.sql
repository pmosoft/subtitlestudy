...
-- 유저의견
-----------------------------
DROP TABLE STTL.TSSCM00050;

CREATE TABLE STTL.TSSCM00050 (
 USR_ID          VARCHAR(40)    NOT NULL COMMENT '사용자아이디'
,OPINION_REG_DTM VARCHAR(12)    NOT NULL COMMENT '의견등록일시분(YYYYMMDDHHMI)'
,OPINION_DESC    VARCHAR(2000)      NULL COMMENT '유저의견'
,REG_DTM         TIMESTAMP          NULL COMMENT '등록일시'
,REG_USR_ID      VARCHAR(40)        NULL COMMENT '등록자'
,UPD_DTM         TIMESTAMP          NULL COMMENT '변경일시'
,UPD_USR_ID      VARCHAR(40)        NULL COMMENT '변경자'
,PRIMARY KEY (USR_ID,OPINION_REG_DTM)
) ENGINE=INNODB DEFAULT CHARSET=UTF8 COMMENT='유저의견';
;
