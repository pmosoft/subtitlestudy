...
,USR_NM      VARCHAR(40)    NOT NULL
,USR_AGE     INT                NULL
,USE_YN       CHAR(1)       NOT NULL
,REG_DT      VARCHAR(14)        NULL
,REG_USR_ID  VARCHAR(20)        NULL
,UPD_DT       DATE              NULL
,UPD_USR_ID  VARCHAR(14)        NULL
,PRIMARY KEY (USR_ID)
)
;

INSERT INTO TSYUR00010 VALUES('ADMIN','ADMIN@PMOSOFT.NET','1','ADMIN',50,'Y','','ADMIN','','ADMIN');
